...
//  SlotMachine
//
//  Created by Tim Pryor on 2014-12-11.
//  Copyright (c) 2014 Tim Pryor. All rights reserved.
//

//*UIKit: provides infrastructure needed to construct and manage iOS apps
...
class ViewController: UIViewController {
  ...
  //*initialize four containers, set to UIView!
  //*UIView!: Optional UIView
  //*UIView class defines a rectangular area on the screen and the interfaces for managing content in that area
  //*At runtime, a view object handles the rendering of any content in its area and also handles any interaction with that content
  ...
  //passing in parameter-don't need to
  func setupFirstContainer(containerView: UIView) {
    self.titleLabel = UILabel()
    self.titleLabel.text = "Super Slots"
    self.titleLabel.textColor = UIColor.yellowColor()
    self.titleLabel.font = UIFont(name: "MarkerFelt-Wide", size: 40)
    self.titleLabel.sizeToFit() //automatically figure out how to make width and height
  ...
  func setupSecondContainer(containerView: UIView) {
    ...
    for var containerNumber = 0; containerNumber < kNumberOfContainers; ++containerNumber {
      for var slotNumber = 0; slotNumber < kNumberOfSlots; ++slotNumber {
        ...
        if self.slots.count != 0 { //slots have been filled
          let slotContainer = slots[containerNumber]
          slot = slotContainer[slotNumber]
          slotImageView.image = slot.image
        } else {
          slotImageView.image = UIImage(named: "Ace") //sets up first cards, all Aces
        }
  ...
  func setupFourthContainer (containerView: UIView) {
    ...
    self.resetButton.addTarget(self, action: "resetButtonPressed:", forControlEvents: UIControlEvents.TouchUpInside) //colon on resetButtonPressed specifies one or more parameters
  ...
  //see comments under video: Miguel, devanish
  func removeSlotImageViews() {
    //THIS WORKS AND SIMPLER
    for view in self.secondContainer.subviews {
