...
//  SlotMachine
//
//  Created by Tim Pryor on 2014-12-22.
...
class Factory {
  class func createSlots() -> [[Slot]] {
    ...
    //slots = [[slot1, slot2, slot3]//col1, [slot4, slot5, slot6]//col2, [slot7, slot8, slot9]//col3]
    
    for var containerNumber = 0; containerNumber < kNumberOfContainers; containerNumber++ {
      var slotArray: [Slot] = []
      for var slotNumber = 0; slotNumber < kNumberOfSlots; slotNumber++ {
        var slot = Factory.createSlot(slotArray) //don't need Factory.
  ...
  class func createSlot(currentCards: [Slot]) -> Slot {
    ...
    var randomNumber = Int(arc4random_uniform(UInt32(13))) //0 to 12
    
    //contains part of Equatable protocol
    while contains(currentCardValues, randomNumber + 1) { //values start from 1 to 13
